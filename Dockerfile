...
# MinIO server
RUN curl -L https://dl.min.io/server/minio/release/linux-amd64/archive/minio.RELEASE.2025-10-15T17-29-55Z -o /usr/local/bin/minio \
    && chmod +x /usr/local/bin/minio

# MinIO client
RUN curl -L https://dl.min.io/client/mc/release/linux-amd64/archive/mc.RELEASE.2025-10-15T17-29-55Z -o /usr/local/bin/mc \
